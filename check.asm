...
CurrentPosWhiteKing db ? ;added for check king
check db ?
...
GerCurrentposKing   proc    far
    ...
    ret
GerCurrentposKing endp



CheckKing   proc    far

    ;Check horizontal -> tabya / wazer
    ;Check diagonal -> feel / wazer / 3askary
    ;Check vertical -> tabya / wazer
...
CheckHorizontal_CheckKing   proc    far

    pusha

    ;Get Current position of King
    ;call GerCurrentposKing
    ...
    ret
CheckHorizontal_CheckKing endp

CheckVertical_CheckKing   proc    far
...
;     cmp Grid[destCellIndex],White_Soldier
;     jne SkipMesgKilled1
...
;     cmp Grid[destCellIndex],Black_Soldier
;     jne SkipMesgKilled2
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;     cmp Grid[destCellIndex],White_Rook
;     jne SkipMesgKilled3
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;     cmp Grid[destCellIndex],Black_Rook
;     jne SkipMesgKilled4
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;     cmp Grid[destCellIndex],White_Elephant
;     jne SkipMesgKilled5
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;     cmp Grid[destCellIndex],Black_Bishop
;     jne SkipMesgKilled6
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;     cmp Grid[destCellIndex],White_Horse
;     jne SkipMesgKilled7
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;     cmp Grid[destCellIndex],Black_Knight
;     jne SkipMesgKilled8
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;     cmp Grid[destCellIndex],White_Queen
;     jne SkipMesgKilled9
;     ;Display message
;     ;move cursor
;     mov ah,2
...
;  SkipMesgKilled9:
;     cmp Grid[destCellIndex],Black_Queen
...
;  SkipMesgKilled10:
;     cmp Grid[destCellIndex],White_King
...
;  SkipMesgKilled11:
;     cmp Grid[destCellIndex],Black_King
...
;-----------------------------Intialize(starting positions)-----------------------------------
    ...
    mov grid[55-8],Black_King
    
    mov grid[62],White_Queen
